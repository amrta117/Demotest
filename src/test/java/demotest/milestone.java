...
public class milestone extends base {
	 ...
	 public void navigateToProject()   {
	    	...
	    	System.out.println("p1");
	    	 ...
	    	 try {
	    	  ...
	    	  WebElement project = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='/project/?view=list']")));
	         ...
	         WebElement projectName = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//table//tr[1]//span[contains(@class,'w-space-no') and contains(@class,'pt-2')]")));
	 ...
	 public void navigateToMilestone()   {
         ...
         WebElement createMilestone = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='milestone']//button[normalize-space(text())='+ Add Milestone']")));
         System.out.println("CREATE Milestone LOCATED");
         createMilestone.click();
         System.out.println("CREATE Milestone CLICKED");
         
         
         driver.findElement(By.name("name")).sendKeys("amrta");System.out.println("name sent");
         // Enter initial name
         //WebElement nameInput = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("name")));
         //nameInput.sendKeys("amrta");
         //System.out.println("Initial name sent");
         ...
         WebElement endDate = wait.until(ExpectedConditions.elementToBeClickable(
             By.xpath("//input[@name='endDate']")));
         endDate.clear();
         endDate.sendKeys(today);
         System.out.println("end date entered");
         
         WebElement tagsInput = wait.until(ExpectedConditions.elementToBeClickable(
        		    By.xpath("//input[starts-with(@id,'react-select') and contains(@id,'-input')]")
        		));
        		tagsInput.click();
        		...
        		WebElement ownerInput = wait.until(ExpectedConditions.elementToBeClickable(
        		    By.xpath("//label[normalize-space()='Owner']/following::input[1]")
        		));
        		ownerInput.click();
    	    	...
    	    	WebElement editMi = wait.until(ExpectedConditions.presenceOfElementLocated(
    	    	        By.xpath("//*[@id='milestone']//i[contains(@class,'fa-pencil-alt')]")
    	    	));
    	    	...
    	    	WebElement MiNameInput = wait.until(ExpectedConditions.visibilityOfElementLocated(
    	    	...
    	    	System.out.println("Updated name sent: " + updatedName);
    	    	WebElement deleteMi = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"milestone\"]//a[contains(@class,'btn-danger')]")));
