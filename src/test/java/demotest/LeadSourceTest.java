...
public class LeadSourceTest extends base{
	    ...
	    public void createLeadSource() {
	        ...
	        WebElement createBtn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(.,'Create')] | //a[contains(.,'Create')]")));
	        createBtn.click();
	        ...
	        // Save lead
	        WebElement saveBtn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(text(),'Save and Close')]")));
	        ...
	        WebElement createdLead = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='lead_source']//li[contains(@class,'list-group-item') and normalize-space(text())='"+leadName+"']")));
	    ...
	    public void editLeadSource() {
	        ...
	        WebElement editIcon = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//*[@id='lead_source']//span[contains(@class,'badge') and contains(@class,'badge-pill') and contains(@class,'pointer')])[1]")));
	        editIcon.click();
	       
	    	System.out.println("4 clicked");
	        // Edit name
	        WebElement leadNameInput = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@name='EditIdName' and @type='text']")));
	        leadNameInput.clear();
	    	...
	    	WebElement createdLead = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[normalize-space(text())='"+leadName+"']")));
	    ...
	    public void deleteLeadSource() {
	        ...
	        WebElement deleteIcon = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//*[@id='lead_source']//span[contains(@class,'pointer')][2])[32]")));   
	        deleteIcon.click();	      
	        
	        WebElement deleconfirm = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(@class,'swal-button') and contains(@class,'swal-button--confirm') and contains(@class,'swal-button--danger')]")));
	        deleconfirm.click();
